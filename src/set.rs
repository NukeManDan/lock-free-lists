...
type NodeAtm<'g,N> = &'g Atomic<N>;
type LoadedNode<'g,N> = (&'g Atomic<N>,Shared<'g,N>);

fn _search<'g,K:Ord,N:Searchable<K>>(head:LoadedNode<'g,N>,tail:LoadedNode<'g,N>,search_key:&K,g:&'g Guard)->(LoadedNode<'g,K>,LoadedNode<'g,K>){
...
fn search<'g,K:Ord>(head:LoadedNode<'g,K>,tail:LoadedNode<'g,K>,search_key:&K,g:&'g Guard)->(LoadedNode<'g,K>,LoadedNode<'g,K>){
